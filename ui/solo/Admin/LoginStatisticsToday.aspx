<%@ Page Title="Статистика посещений клиента сегодня" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginStatisticsToday.aspx.cs" Inherits="Solo.Admin.LoginStatisticsToday" %>
    ...
    <table class="basicTable loginStatisticsTodayTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <%=DataHelper.GetVkontakteAccountsActiveCountByUserName(ListDesctop[i].UserName)%>
                </td>
                <td>
