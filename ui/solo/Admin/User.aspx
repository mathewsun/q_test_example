<%@ Page Title="Пользователь" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Solo.Admin.User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="elementsTable">
        ...
        <tr>
            <td><a href="VkAccounts.aspx?userid=<%= UserItem.UserId %>">Аккаунтов</a>:
            </td>
            <td>
                <asp:Label ID="LabelVkAccountsCount" runat="server" />
            </td>
        </tr>
        <tr>
            <td><a href="VkAccountDeleted.aspx?userid=<%= UserItem.UserId %>">Удаленных аккаунтов</a>:
            </td>
            <td>
                <asp:Label ID="LabelVkAccountsDeletedCount" runat="server" />
            </td>
        </tr>
        <tr>
            <td>Заблокирован:
            ...
            <td colspan="2">
                <table class="basicTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <%=UserItem.Earned.ToString("N2") %>
                        </td>
                        <td></td>
                        <td>
                            <%=UserItem.Spend.ToString("N2") %>
                        </td>
                        <td>
                            <%=UserItem.CashIn.ToString("N2") %>
                        </td>
                        <td>
                            <%=UserItem.CashOut.ToString("N2") %>
                        </td>
                        <td>
        ...
        <tr>
            <td>Баланс:</td>
            <td>
                <asp:TextBox ID="TextBoxBalance" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Button ID="ButtonSave" runat="server" Text="Обновить баланс" OnClick="ButtonSave_Click" />
            </td>
        </tr>
        <tr>
            <td>Управление:</td>
