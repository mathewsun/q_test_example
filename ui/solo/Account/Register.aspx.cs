...
namespace Solo.Account
{
    public partial class Register : Page
    {
        ...
        protected void RegisterUser_CreatedUser(object sender, EventArgs e)
        {
            ...
            //if (_refid != 0)
            //{
            //    DataHelper.AddReferral(new Solo.Model.Referrals
            //    {
            ...
            //Увеличиваем количество в настройках
            Model.Settings sett = DataHelper.GetSettingByName("UsersCount");
            sett.Value = (Int32.Parse(sett.Value) + 1).ToString();
            DataHelper.UpdateSetting(sett);
