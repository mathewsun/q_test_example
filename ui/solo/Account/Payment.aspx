<%@ Page Title="Перевод средств" Language="C#" MasterPageFile="~/SiteBalance.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Solo.Account.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            var recepientId = getParameterByName("id");

            if (recepientId != null) {
                $('#TextBoxPaymentAddress').val(recepientId);
            }
        });
