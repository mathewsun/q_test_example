<%@ Page Title="Рефералы" Language="C#" MasterPageFile="~/SiteBalance.Master" AutoEventWireup="true" CodeBehind="Referrals.aspx.cs" Inherits="Solo.Account.Referrals" %>
    ...
    <table id="referalTable" class="basicTable referalTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="balanceFirstLevelAddToday"><%= (Math.Truncate((user.EarnedToday / 100 * ReferralsPercentFirstLevel) * 100) / 100).ToString("F2") %></span>
                </td>
                <td>
                    <span class="balanceFirstLevelAdd"><%= (Math.Truncate((user.Earned / 100 * ReferralsPercentFirstLevel) * 100) / 100).ToString("F2")%></span>
                </td>
            </tr>
            <% } %>
        </tbody>
    ...
    <table id="Table2" class="basicTable referalTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="balanceSecondLevelAddToday"><%= (Math.Truncate((user.EarnedToday / 100 * ReferralsPercentSecondLevel) * 100) / 100).ToString("F2")%></span>
                </td>
                <td>
                    <span class="balanceSecondLevelAdd"><%= (Math.Truncate((user.Earned / 100 * ReferralsPercentSecondLevel) * 100) / 100).ToString("F2")%></span>
                </td>
            </tr>
            <% } %>
        </tbody>
    ...
    <table id="Table1" class="basicTable referalTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="balanceThirdLevelAddToday"><%= (Math.Truncate((user.EarnedToday / 100 * ReferralsPercentThirdLevel) * 100) / 100).ToString("F2")%></span>
                </td>
                <td>
                    <span class="balanceThirdLevelAdd"><%= (Math.Truncate((user.Earned / 100 * ReferralsPercentThirdLevel) * 100) / 100).ToString("F2")%></span>
                </td>
            </tr>
            <% } %>
        </tbody>
