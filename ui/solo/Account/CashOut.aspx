<%@ Page Title="Вывод" Language="C#" MasterPageFile="~/SiteBalance.Master" AutoEventWireup="true" CodeBehind="CashOut.aspx.cs" Inherits="Solo.Account.CashOut" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="elementsTable">
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="ButtonCashOut" CssClass="button" runat="server" Text="Вывести" OnClick="ButtonCashOut_Click" OnClientClick="if (ValidateForm() == false) return(false);" />
            </td>
        </tr>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            menuItems.filter("[id*='CashOutLink']").parent().addClass("active");
        });
    </script>
