<%@ Page Title="Регистрация" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Solo.Account.Register" %>
            ...
            <asp:CreateUserWizardStep runat="server" ID="RegisterUserWizardStep">
                <ContentTemplate>
                    ...
                    <table class="elementsTable registerTable">
                        ...
                        <tr>
                           <td colspan="2">
                                <div style="margin-left:10px;" class="g-recaptcha" data-sitekey="6Ld6F4sUAAAAAKvIL5iZ-oUDoPV1MTSi5v8G-5Qs"></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
