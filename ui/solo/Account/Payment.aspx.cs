...
namespace Solo.Account
{
    public partial class Payment : BasicPage
    {
        ...
        protected void ButtonMakePayment_Click(object sender, EventArgs e)
        {
            ...
            DataHelper.UpdateUserBalance(User.UserId, -value, UpdateBalanceType.PaymentOut);
            ...
            DataHelper.UpdateUserBalance(userRecepient.UserId, value, UpdateBalanceType.PaymentIn);
