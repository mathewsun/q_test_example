<%@ Page Title="Вход" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Solo.Account.Login" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false" OnLoggingIn="On_LoggingIn" DisplayRememberMe="False" OnLoggedIn="Unnamed1_LoggedIn">
        <LayoutTemplate>
            ...
            <table class="elementsTable loginTable">
                ...
                <tr>
                    <td colspan="2">
                        <div class="g-recaptcha" data-sitekey="6Ld6F4sUAAAAAKvIL5iZ-oUDoPV1MTSi5v8G-5Qs"></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
    ...
    <p>
        Или <asp:HyperLink runat="server" ID="RegisterHyperLink" NavigateUrl="~/Account/Register.aspx" CssClass="registrate-button" ViewStateMode="Disabled">Зарегистрируйтесь</asp:HyperLink><span class="registrate-text">.</span>
    </p>
